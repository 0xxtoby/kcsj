...
<%--                                    <li><a href="mailbox.html#"> <i class="fa fa-circle text-warning"></i> Clients</a></li>--%>
                ...
                <div class="col-lg-9 animated fadeInRight">
                    ...
                    <div class="mail-box">
                        <form class="form-horizontal" method="post" action="blog_compose">
                        ...
                        <div class="mail-body" >
                                ...
                                <div class="form-group "><label class="col-sm-2 control-label">分类:</label>
                                    <div class="btn-group" style="margin-left: 15px;">
                                        <% String Category_boo= (String) request.getAttribute("category_boo");
                                            System.out.println(Category_boo);

                                        if (Category_boo==null||"".equals(Category_boo)){
//                                            System.out.println("11");
                                            String category_id= (String) request.getAttribute("category_id");
                                            Category category22=new Category();
                                            category22=categoryDao.get_Category(Integer.parseInt(category_id)); %>
                                        <button  data-toggle="dropdown" class="btn btn-primary dropdown-toggle" aria-expanded="false"><%=category22.getTitle()%> <span class="caret"></span></button>
                                        <input name="category_id" value="<%=category22.getId()%>" style="display: none">
                                        <% }
                                        else {
//                                            System.out.println("22");
                                            System.out.println("类型初始化");
                                           %>

                                        <button name="category" value="-1" data-toggle="dropdown" class="btn btn-primary dropdown-toggle" aria-expanded="false">请选择分类 <span class="caret"></span></button>
                                        <input name="category_id" value="-1" style="display: none">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <% List<Category> categories1= categoryDao.get_categorys();
                                                for (Category category:categories){
                                            %>
                                            <li><a type="submit" href="blog_compose?category_id=<%=category.getId()%>" ><%=category.getTitle()%></a></li>
...
<%--                                            <li><a href="buttons.html#">py</a></li>--%>
                        ...
                        <div class="mail-text h-200">
                            ...
                            <textarea name="content" data-provide="markdown" rows="20"  placeholder="123s" >请输入文章 </textarea>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="mail-body text-right tooltip-demo">
                            ...
                            <button type="submit"  name="action" value="send" class="btn btn-sm btn-primary " data-toggle="tooltip" data-placement="top" title="Send" ><i class="fa fa-reply"></i>保存 </button>
